...
<head>
  ...
  <title>Nurmayanti E-Learning</title>
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Welcome to <span>E-Learning</span></h1>
          <p data-aos="fade-up" data-aos-delay="100">Web Ini membantu kamu mengetahui course serta identitas kamu <br></p>
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">Nurmayanti</span>
          </a>
